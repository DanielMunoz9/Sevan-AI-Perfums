        ...
        <motion.div initial={{opacity: 0, y: 50}} whileInView={{opacity: 1, y: 0}} transition={{duration: 0.8}} viewport={{once: true}} className="mb-24">
          <div className="text-center mb-12">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-6xl md:text-8xl font-serif font-bold mb-6 leading-tight">
              ...
              <p className="text-2xl text-gray-200 font-light tracking-wider">Luxury Fragrances</p>
              <p className="text-lg text-gray-400 max-w-3xl mx-auto mt-3">
                Descubre la excelencia en cada fragancia
              </p>
            </motion.div>
          </div>
              ...
              <div className="relative z-10 p-6 md:p-10">
                ...
                <div className="relative aspect-video rounded-2xl overflow-hidden bg-gradient-to-br from-gold/10 via-black to-gold/5 border-2 border-gold/30 shadow-[inset_0_0_60px_rgba(212,175,55,0.1)]">
                  <iframe 
                    ...
                    src="https://www.youtube.com/embed/eu-IZHk_xeY?autoplay=1&mute=1&controls=0&rel=0&modestbranding=1&playsinline=1&loop=1&playlist=eu-IZHk_xeY&enablejsapi=1" 
                    title="SEVÁN PERFUM" 
